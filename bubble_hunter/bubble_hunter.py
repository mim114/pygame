...
c = Canvas(window, width=WIDTH, height=HEIGHT, bg='darkblue') # bg цвет фона
c.pack()
ship_id = c.create_polygon(5, 5, 5, 25, 30, 15, fill='red')
ship_id2 = c.create_oval(0, 0, 30, 30, outline='red') # outline цвет контуура
c.move(ship_id, MID_X, MID_Y)
c.move(ship_id2, MID_X, MID_Y) # перемещение в центр экрана
c.bind_all('<Key>', move_ship) # связываем кнопку с функцией
